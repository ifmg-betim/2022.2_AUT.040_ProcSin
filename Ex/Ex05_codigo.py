def capturaSinalSecreto(ar):
    ...
    X=requests.get('https://github.com/ifmg-betim/2022.2_AUT.040_ProcSin/blob/main/Ex/Ex05_arquivo.wav?raw=true')
    A("Ex05_arquivo.wav","wb").write(X.content)
    fs,v=wavfile.read('Ex05_arquivo.wav')
